function [T_motor, F_regen] = regen_braking(state,params,F_brake)
    ...
    T_motor = max(T_motor, max_regen_torque(state.RPM_motor,params)); % limits the negative torque to the max that can be supplied or is required
